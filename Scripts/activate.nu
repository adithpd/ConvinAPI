...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Prithvik02\StudioProjects\Dashboard\convin\env_site'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Prithvik02\StudioProjects\Dashboard\convin\env_site\Scripts\deactivate.nu'
